...
class TestMilvusClientWithMocking:
    """Test MilvusClient methods that require mocking the client"""
...
class TestEmbeddingFunctions:
    """Test embedding functions with proper mocking"""
...
class TestDeprecatedMethods:
    """Test deprecated embedding methods"""
...
class TestScriptWorkflows:
    ...
    @patch('MilvusClient.client')
    def test_collection_creation_workflow(self, mock_client):
    ...
    @patch('MilvusClient.client')
    def test_collection_drop_workflow(self, mock_client):
    ...
    def test_database_creation_workflow(self):
