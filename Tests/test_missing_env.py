...
try:
    ...
    result = EmbeddingProvider.embed_text("test", provider='huggingface')
...
try:
    ...
    result = EmbeddingProvider.embed_text("test", provider='ollama')
    print(f"   Result: {len(result)} dimensions")
except Exception as e:
    print(f"   ERROR: {e}")
...
try:
    ...
    result = EmbeddingProvider._embed_ollama("test")
    print(f"   Result: {len(result)} dimensions")
except Exception as e:
    print(f"   ERROR: {e}")
