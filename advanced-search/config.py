    ...
    def from_env(cls, provider: str) -> 'ProviderConfig':
        ...
        if provider == ModelProvider.HUGGINGFACE:
            ...
            return cls(
                ...
                default_model=os.getenv("MODEL_HF", "mistralai/Mixtral-8x7B-Instruct-v0.1"),
                # Use provider-specific collection name
                collection_name=f"milvus_hf_collection",
                # Always use a consistent embedding model with 768 dimensions
            ...
            return cls(
                ...
                default_model=os.getenv("MODEL_OLLAMA", "llama2"),
                # Use provider-specific collection name
                collection_name=f"milvus_ollama_collection",
